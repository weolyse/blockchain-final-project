...
### 4.2 Vault Tests
- [ ] `YieldVault.t.sol` ≥10 unit tests
- [ ] Fuzz: `testFuzz_VaultDepositWithdraw(uint96 assets)` — rounding invariants hold
- [ ] Fuzz: `testFuzz_VaultInflationAttack(uint96 frontrun)` — donation attack mitigated
