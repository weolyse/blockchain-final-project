...
export class YieldReported extends ethereum.Event {
  get params(): YieldReported__Params {
    return new YieldReported__Params(this);
  }
}

export class YieldReported__Params {
  _event: YieldReported;

  constructor(event: YieldReported) {
    this._event = event;
  }

  get grossYield(): BigInt {
...
export class YieldVault extends ethereum.SmartContract {
  ...
  try_PERFORMANCE_FEE_BPS(): ethereum.CallResult<BigInt> {
  ...
  try_totalPerformanceFees(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalPerformanceFees",
      "totalPerformanceFees():(uint256)",
      [],
...
export class ReportYieldCall extends ethereum.Call {
  get inputs(): ReportYieldCall__Inputs {
    return new ReportYieldCall__Inputs(this);
  }

  get outputs(): ReportYieldCall__Outputs {
    return new ReportYieldCall__Outputs(this);
  }
}

export class ReportYieldCall__Inputs {
  _call: ReportYieldCall;

  constructor(call: ReportYieldCall) {
    this._call = call;
  }
...
export class ReportYieldCall__Outputs {
  _call: ReportYieldCall;
